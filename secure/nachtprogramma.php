...
if( $user_info_permissions & PERMISSION_NACHT != PERMISSION_NACHT ) {
    return false;
}
...
$resultHTML.="<th>Omschrijving</th>";
$resultHTML.="<th>Benodigdheden</th>";
$resultHTML.="<th>Ingedeeld:</th>";
$resultHTML.="</tr></thead>";

$query = "SELECT p.firstname, p.lastname, p.email, p.phone, c0.type, c0.description, c0.needs, c1.type, c1.description, c1.needs, b.task FROM buyer b join person p on p.email = b.email join contribution c0 on c0.id = p.contrib0 join contribution c1 on c1.id = p.contrib1 WHERE c0.type IN ('workshop','game','lecture','schmink','other','perform','install') AND b.complete = 1";
