...
while($row = mysqli_fetch_array($sqlresult,MYSQLI_NUM))
{
    ...
    $resultHTML.="<td><div class='table-cell'><select class='form-control'>
                                ...
                                <option value='camping' selected>Campingwinkel</option>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class='alert alert-info'><span class='glyphicon glyphicon-user' aria-hidden='true'></span> <?=$count?> campingwinkeliers</div>
